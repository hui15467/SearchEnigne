...
import java.io.*;
/*DocumentBuilder 是Document的构造器的类，是AbstractDocumentBuilder的实现类
* Document构造器的功能应该由解析文本文档得到的TermTupleStream,产生Document对象
* */
